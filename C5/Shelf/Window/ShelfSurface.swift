...
struct ShelfSurface: NSViewRepresentable {
    ...
    final class SurfaceView: NSView {
        ...
        override func draggingEntered(_ sender: NSDraggingInfo) -> NSDragOperation {
            ...
            NSLog("[C5] draggingEntered types=%@", sender.draggingPasteboard.types?.map(\.rawValue) ?? [])
        ...
        override func prepareForDragOperation(_ sender: NSDraggingInfo) -> Bool {
            ...
            NSLog("[C5] prepareForDragOperation -> %@", ok ? "true" : "false")
            return ok
        }
        ...
        override func performDragOperation(_ sender: NSDraggingInfo) -> Bool {
            ...
            NSLog("[C5] performDragOperation contents=%d", contents.count)
